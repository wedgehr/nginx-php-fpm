...
COPY conf/nginx.supervisor.conf /etc/supervisor/conf.d/nginx.supervisor.conf
COPY conf/php-fpm.supervisor.conf /etc/supervisor/conf.d/php-fpm.supervisor.conf
